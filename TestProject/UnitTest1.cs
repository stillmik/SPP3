...
namespace TestProject
{
    ...
    public class Tests
    {
        ...
        public string P { get; set; } //for c# it also field, m* get,m* set
        public int x;

        [SetUp]
        public void Setup()
        {
            ad = Solution3.AssemblyBrowser.GetAssemblyData(@"..\netcoreapp3.1\NUnitTest.dll");
        }
        ...
        public void TestAssemblyBrowser()
        {
            ...
            Assert.AreEqual(ad.Namespaces[0].Classes[1].Members[2].Items[10],
                "Extension:Int32 EM(NUnitTest.Tests, Int32)");
        }
    }
}